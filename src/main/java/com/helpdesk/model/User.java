...
public class User {
    ...
    @JsonProperty(access = JsonProperty.Access.WRITE_ONLY)  // Accept from frontend, don't send back
    ...
    @Column(nullable = false)
    private String role; // ADMIN, ENGINEER, EMPLOYEE
    ...
    // Break circular reference: don't serialize tickets from user side
